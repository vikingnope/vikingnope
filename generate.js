...
(async () => {
  try {
    ...
    // Buy Me a Coffee (Simple Icons) - Path for the "Cup"
    const bmcPath = "M20.216 6.426l-1.29-3.328a3.174 3.174 0 0 0-3.17-2.098H8.244a3.175 3.175 0 0 0-3.17 2.099L3.784 6.425C1.56 7.425.074 9.613.074 12.046c0 3.328 2.395 6.132 5.568 6.837.29 2.455 1.517 6.64 4.542 6.666h.142c.866 0 1.637-.23 2.277-.63l.797-.502.797.502c.64.4 1.411.63 2.278.63h.142c3.024-.025 4.25-4.21 4.542-6.666 3.173-.705 5.568-3.51 5.568-6.837 0-2.433-1.485-4.621-3.71-5.62ZM8.67 3.5h6.66l.89 2.3H7.78l.89-2.3Zm-3.1 3.8h12.86c2.4 0 4.14 1.96 3.91 4.34-.14 1.5-.96 2.8-2.22 3.63-.3.2-.6.4-.9.6l-.37.25c-.24.16-.48.33-.71.5-.1.08-.2.15-.31.23-.21.16-.41.31-.61.46-.22.18-.45.35-.67.52-.39.29-.78.58-1.16.85l-.23.23c-.31.31-.63.63-.95.95l-.17.17c-.31.31-.62.61-.93.91l-.11.11a22.25 22.25 0 0 1-2.9 2.3h-.02a22.37 22.37 0 0 1-2.9-2.3l-.11-.11c-.31-.3-.62-.6-.93-.91l-.17-.17c-.32-.32-.64-.64-.95-.95l-.23-.23c-.38-.27-.77-.56-1.16-.85-.23-.17-.45-.34-.67-.52l-.61-.46c-.11-.08-.21-.15-.31-.23-.23-.17-.47-.34-.71-.5l-.37-.25c-.3-.2-.6-.4-.9-.6-1.26-.83-2.08-2.13-2.22-3.63-.23-2.38 1.51-4.34 3.91-4.34Z";
    // Adjust xOffset to center "Icon + Text" manually. 
    // Button Width 200. Text "Buy me a coffee" ~120px + Icon 24px + Gap 10px = 154px. Start ~ (200-154)/2 = 23px.
    ...
    const paypalPath = "M14.06 3.713c.12-1.071-.093-1.832-.702-2.526C12.628.356 11.312 0 9.626 0H4.734a.7.7 0 0 0-.691.59L2.005 13.509a.42.42 0 0 0 .415.486h2.756l-.202 1.28a.628.628 0 0 0 .62.726H8.14c.429 0 .793-.31.862-.731l.025-.13.48-3.043.03-.164.001-.007a.35.35 0 0 1 .348-.297h.38c1.266 0 2.425-.256 3.345-.91q.57-.403.993-1.005a4.94 4.94 0 0 0 .88-2.195c.242-1.246.13-2.356-.57-3.154a2.7 2.7 0 0 0-.76-.59l-.094-.061ZM6.543 8.82a.7.7 0 0 1 .321-.079H8.3c2.82 0 5.027-1.144 5.672-4.456l.003-.016q.326.186.548.438c.546.623.679 1.535.45 2.71-.272 1.397-.866 2.307-1.663 2.874-.802.57-1.842.815-3.043.815h-.38a.87.87 0 0 0-.863.734l-.03.164-.48 3.043-.024.13-.001.004a.35.35 0 0 1-.348.296H5.595a.106.106 0 0 1-.105-.123l.208-1.32z";
    // Text "PayPal" ~ 50px + Icon 16px + Gap 10px = 76px. Start ~ (200-76)/2 = 62px.
