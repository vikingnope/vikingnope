...
(async () => {
  try {
    ...
    const bmcPath = "M6.898 0L5.682 2.799H3.877v2.523h.695L5.277 9.8H4.172l1.46 8.23.938-.01L7.512 24h8.918l.062-.4.88-5.58.888.01 1.46-8.231h-1.056l.705-4.477h.756V2.8h-1.918L16.99 0H6.898zm.528.805h9.043l.019.066h.007l1.043 8.16h-1.57l-.547 4.145h1.378l-.683 4.331H7.859l-.68-4.331h1.383l-.55-4.145H6.445l1.043-8.16h.011zm1.758 13.926h2.89l.196 1.25h-3.282zm3.882 0h2.895l.192 1.25h-3.282z";
    fs.writeFileSync(path.join(OUTPUT_DIR, 'button-bmc.svg'), CreateButton({ iconPath: bmcPath, label: 'Buy me a coffee', color: '#e8e4dc', iconViewBox: "0 0 24 24" }));

    // PayPal (Bootstrap Icons)
    ...
    fs.writeFileSync(path.join(OUTPUT_DIR, 'button-paypal.svg'), CreateButton({ iconPath: paypalPath, label: 'PayPal', color: '#e8e4dc', iconViewBox: "0 0 16 16" }));
